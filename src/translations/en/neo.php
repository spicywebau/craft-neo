...
return [
    ...
    'Disable' => 'Disable',
    'Enable' => 'Enable',
    'Copy block anchor ID' => 'Copy block anchor ID',
    ...
    'Block anchor ID prefix' => 'Block anchor ID prefix',
    'The prefix to use for block anchor IDs.' => 'The prefix to use for block anchor IDs.',
];
