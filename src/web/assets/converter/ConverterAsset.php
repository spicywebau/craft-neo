...
/**
 * Asset bundle class for Neo-to-Matrix conversion.
 *
 * @package benf\neo\web\assets\converter
 ...
 * @since 5.0.0
 */
class ConverterAsset extends AssetBundle
{
    /**
     * @inheritdoc
     */
    ...
    {
        $this->sourcePath = '@benf/neo/web/assets/converter/dist';
