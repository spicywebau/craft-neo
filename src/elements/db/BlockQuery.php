...
class BlockQuery extends ElementQuery
{
    ...
    protected function beforePrepare(): bool
    {
        ...
        //     $this->query->groupBy('neoblocks.fieldId, neoblocks.ownerId, neoblocks.typeId, neoblocks.sortOrder, elements_sites.uri, elements_sites.siteId, elements_sites.enabled, content.id, structureelements.structureId, structureelements.root, structureelements.lft, structureelements.rgt, structureelements.level, elements_sites.slug, elements.id');
        // }
        // we should sort by the neoblocks sortOrder instead.
    ...
    public function afterPrepare(): bool
    {
        ...
        // we should sort by the neoblocks sortOrder instead.
        $this->query->orderBy(['neoblocks.sortOrder' => $this->defaultOrderBy]);
        // $this->subQuery->orderBy(['neoblocks.sortOrder' => $this->defaultOrderBy]);
        
        return parent::afterPrepare(); // TODO: Change the autogenerated stub
    }
