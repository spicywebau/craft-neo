...
return [
    [
        'id' => null,
        'sectionId' => '1',
        'typeId' => Craft::$app->getEntries()->getEntryTypeByUid('entrytype-00000000000000000000000001')->id,
        'authorId' => '1',
    ...
    [
        'id' => null,
        'sectionId' => '1',
        'typeId' => Craft::$app->getEntries()->getEntryTypeByUid('entrytype-00000000000000000000000002')->id,
        'authorId' => '1',
